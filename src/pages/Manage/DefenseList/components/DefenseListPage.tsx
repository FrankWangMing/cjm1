...
export const DefenseListPage = observer(() => {
        ...
        <div
          ...
          <div
            onClick={() => {
              ...
              store.editData = store.defenseListData.filter(item => {
                return item['id'] == _;
              })[0];
            }}
          ...
          <Popconfirm
            title="确认删除？"
            onConfirm={() => store.delDefenseData(_)}>
            <a>删除</a>
          </Popconfirm>
        </div>
      )
    ...
    <Wrapper>
      <Form layout="inline" form={form} className="search-form">
        ...
        <Button style={{ marginLeft: '20rem' }} type="primary">
          <Popconfirm
            ...
            onConfirm={() => handleResetInfluence()}>
      ...
      <div className="add-container">
        ...
        <span className="total-count">
          总条数：{store.defenseListData.length}
        </span>
      </div>
      <Table
        dataSource={store.defenseListData}
        pagination={{
